# helper.py from https://gist.github.com/jason-w/4969476
# converts a mongodb document to a dictionary
from mongoengine import Document, ListField, EmbeddedDocumentField, DecimalField, ObjectIdField, BooleanField, IntField, \
    FloatField, StringField, ComplexDateTimeField, DateTimeField, EmbeddedDocument, DictField
